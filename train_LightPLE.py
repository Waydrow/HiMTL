...
if __name__ == "__main__":
	...
	print('Start train LightPLE')


	if task_type == 'binary':
		# 4.Define Model,train,predict and evaluate
		model = LightPLE(dnn_feature_columns, task_types=['binary', 'binary', 'binary'],
		...
		# 4.Define Model,train,predict and evaluate
		model = LightPLE(dnn_feature_columns, task_types=['binary', 'regression', 'regression'],
					 task_names=['label_clk', 'label_cate', 'label_customer'])
