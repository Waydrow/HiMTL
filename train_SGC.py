...
if __name__ == "__main__":
	...
	print('Start train SGC')


	if task_type == 'binary':
		# 4.Define Model,train,predict and evaluate
		model = SGC(dnn_feature_columns, task_types=['binary', 'binary', 'binary'],
		...
		# 4.Define Model,train,predict and evaluate
		model = SGC(dnn_feature_columns, task_types=['binary', 'regression', 'regression'],
					 task_names=['label_clk', 'label_cate', 'label_customer'], shared_expert_num=2, specific_expert_num=2)
