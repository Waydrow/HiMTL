...
def SGC(dnn_feature_columns, shared_expert_num=1, specific_expert_num=1, relation_num = 2, num_levels=2,
	...
	ple_inputs = [dnn_input] * (num_tasks + relation_num)  # [task1, task2, ... taskn, shared task1, shared task2...]
	ple_outputs = []
